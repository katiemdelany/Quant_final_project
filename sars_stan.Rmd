...
In the context of a deterministic SIR, in order to estimate the transmission and the recovery rate, we attempted to use two different specifications and to fit the models using Stan's NUTS algorithm and the mean-field ADVI variant; however, we were unsuccessful in adding the mean-field ADVI variant modeling fitting.
