...
```{r load_sars_data, echo = TRUE}
onset <- sars_canada_2003$date
data <- data.frame(sars_canada_2003$cases_travel, sars_canada_2003$cases_household, sars_canada_2003$cases_healthcare, sars_canada_2003$cases_other)
cases <- rowSums(data)
cases <- data.frame(cases, c=cumsum(cases))
cases <- cases$c
cases <- c(1,1,1,2,2,3,3,3,4,4,5,5,6,6,7,8,8,10,13,13,15,17,22, 29,38,45,48,52,53,57,62,69,76,83,90,93,96,101,104,109,116,120,124,126,129,130,131,132,132,132, 134, 135, 138, 140, 140, 141, 141, 141, 142, 142, 142, 143, 143, 143, 143, 144, 145, 146, 146, 147, 147, 147, 147, 148, 148, 150, 150, 153, 155, 157, 158, 160, 163, 167, 172, 177, 181, 187, 193, 197, 205, 210 ,216, 223, 228, 237, 238, 240, 243, 244, 245, 247, 247, 247, 247, 249, 249, 249, 249, 250)

N = length(onset)
pop = 31640000
sample_time=1:N
sars_data = list(n_obs = N,
                n_theta = 2,
                n_difeq = 3,
                n_pop = pop,
                y = cases,
...
#onset <- dengue_yap_2011$onset_date
#cases <- dengue_yap_2011$value
#N=length(onset)
#pop = 7391
#sample_time = 1:N
#dengue_data = list(n_obs = N,
#                n_theta = 2,
#                n_difeq = 3,
#                n_pop = pop,
#                y = cases,
...
```{r NUTS_fit1, dependson=c("load_sars_data"), echo=FALSE}
n_chains=5
n_warmups=500
n_iter=100500
n_thin=50
...
nuts_fit_1 = sampling(m1, data = sars_data, pars = parameters, init = ini_1, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=13219)
...
vb_fit_1=vb(m1, data = sars_data, pars = parameters, init = ini_1, iter = 1000, tol_rel_obj = 0.001, seed=16735679) #changed initial values
...
nuts_fit_2 = sampling(m2, data = sars_data, pars = parameters, init = ini_1, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=259158591)
...
vb_fit_2=vb(m2, data = sars_data, pars = parameters, init = ini_vb_2, iter = 10000, tol_rel_obj = 0.001, seed=121671623)
...
test = sampling(m3, data = sars_data, pars = parameters_stoch, init = ini_3, chains = 1, iter = 10)
time.start_nuts3 <- Sys.time()
nuts_fit_3 = sampling(m3, data = sars_data, pars = parameters_stoch, init = ini_3, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=13219)
...
vb_fit_3=vb(m3, data = sars_data, pars = parameters_stoch, init = ini_vb_3, iter = 10000, tol_rel_obj = 0.001, seed=24176217)
