...
vb_fit_1=vb(m1, data = sars_data, pars = parameters, init = ini_vb_1, iter = 10000, tol_rel_obj = 0.001, seed=16735679)
...
nuts_fit_2 = sampling(m2, data = sars_data, pars = parameters, init = ini_2, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=259158591)
