...
vb_fit_1=vb(m1, data = mers_data, pars = parameters, init = ini_vb_1, iter = 10000, tol_rel_obj = 0.001, seed=16735679)
...
nuts_fit_2 = sampling(m2, data = mers_data, pars = parameters, init = ini_2, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=259158591)
...
vb_fit_2=vb(m2, data = mers_data, pars = parameters, init = ini_vb_2, iter = 10000, tol_rel_obj = 0.001, seed=121671623)
...
vb_fit_3=vb(m3, data = mers_data, pars = parameters_stoch, init = ini_vb_3, iter = 10000, tol_rel_obj = 0.001, seed=24176217)
